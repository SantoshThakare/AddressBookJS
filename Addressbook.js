class Contact{
    ...
    set email(email){
        let regex = RegExp('^[a-z]+([.$][a-zA-Z0-9]+)*[@][a-zA-Z0-9]+[.][a-zA-Z]{2,3}([.][a-zA-Z]{2})?$')
        if(regex.test(email))
            this._email = email
...
let contact1 = new Contact("Hari", "Prasad", "Ambejogai", "Beed", "Delhi", "4431519", "91 9503324461", "hari@gmail.com")
let contact2 = new Contact("Rajesh", "Goud", "Shirdi", "Ahmednagar", "Bihar","414501","91 9604315270","rajesh@gmail.com");
